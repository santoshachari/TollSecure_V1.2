...
public class FloatAmountDetailsController {
	...
	//updated version we can remove above method soon after this starts working
	@RequestMapping("/showForm1")
	public String AddFloatAmountDetails1(HttpSession session, Model theModel, HttpServletRequest request) {
		...
		return "add_float_amount_details1";
	}
