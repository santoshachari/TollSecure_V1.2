...
<!DOCTYPE html>
<head>
	<title>Cancel Tickets Transaction Report</title>
	...
	<script>
		...
		var action = "CancellationticketstxnReport";
		...
		function getReport() {
			...
			if (! date_error && ! from_error && ! to_error) {
				...
				url = url + "?from="+from+"&to="+to+"&shiftId="+shiftId+"&laneId="+laneId;
		...
		<div class="row">
			<div class="col-sm-12 header hidden-print" style=" min-width: 102%;">
				<div class="row">
					...
					<div class="col-xs-5">
							<h4 class="heading" style="font-size: 0.9em">Cancel Tickets Transaction Report</h4>
						<div></div>
					</div>
		...
		<div class="row">
			<div class="col-sm-12 black_header hidden-print">
				...
				<div class="col-md-11">
					...
					<%-- <label style="margin-left: -250px">TC. </label>
					<select name="userId" id="userId" class="head_inp" style="margin-top:15px; margin-left: -10px; max-width: 100px">
					...
					<label style="margin-left: -380px">SHIFT: </label>
		...
		<div class="visible-xs container" >
			...
			<div class="row">
				<div class="col-xs-12" style="background-color: #ee9620">
					...
					<br><span style="margin-left:15%">Cancel Tickets Transaction Report</span>
				</div>
			</div>
