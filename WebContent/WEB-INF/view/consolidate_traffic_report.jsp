...
<!DOCTYPE html>
<head>
	<title>Consolidated Traffic Report</title>
	...
	<script>
		...
		var action = "ConsolidatedTrafficReport";
		...
		<div class="row">
			<div class="col-sm-12 header hidden-print" style=" min-width: 102%;">
				<div class="row">
					...
					<div class="col-xs-5">
							<h4 class="heading" style="font-size: 0.9em"> Consolidated Traffic Report</h4>
						<div></div>
					</div>
	...
	<div class="visible-xs container" >
		...
		<div class="row">
			<div class="col-xs-12" style="background-color: #ee9620">
				...
				<br><span style="margin-left:20%">Consolidated Traffic Report</span>
			</div>
		</div>
