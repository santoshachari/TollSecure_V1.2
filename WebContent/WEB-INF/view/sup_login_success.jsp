...
<body style="background-image: url(${pageContext.request.contextPath}/resources/images/TS_BG_03.jpg)" >
 ...
 --%>					            	<div class="col-md-4 innermost">
					            	...
					            	<div class="col-md-4 col-sm-offset-1 innermost notordinary">
					            		<ul>
					            			<li>
					            				<a href="${pageContext.request.contextPath}/cashup/declareCash" class="button">Cashup Declaraion</a>
					            			</li>
					            		</ul>
					            	</div>
					            	...
					            	<div class="col-md-4 innermost" style="position: absolute; top:300px; left: 0;">
					            		<ul>
					            			<li>
					        ...
					        <div class="col-md-12" style="margin-top: -30px">
					             <div class="row report">
					            	...
					            	<div class="col-md-4 innermost">
					            		<ul>
					            			<li>
					            				<a href="#" class="button" style="background: transparent; border:0; background-image: url(${pageContext.request.contextPath}/resources/images/but1.png) ; background-size: cover; padding-top: 40">Pass Analysis <br/>&nbsp;</a>
					            	...
					            	<div class="col-sm-4 innermost col-sm-offset-1 notordinary">
					            		<ul>
					            			<li>
					        ...
					        <div class="col-md-12">
					           <div class="row">
					            	...
					            	<div class="col-md-4 col-sm-offset-5 innermost" style="position: relative; left:-42%">
					            		<ul>
					            			<li>
					            				<a href="${pageContext.request.contextPath}/pass/newPass" class="button">Generate Pass</a>
					            			</li>
