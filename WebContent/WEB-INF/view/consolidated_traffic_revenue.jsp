		...
		<div class="row">
			<div class="col-sm-12 header hidden-print" style=" min-width: 102%;">
				<div class="row">
					...
					<div class="col-xs-5">
							<h4 class="heading">Consolidated Traffic and revenue Report</h4>
						<div></div>
					</div>
		...
		<div class="row">
			<div class="col-sm-12 black_header hidden-print">
				...
				<div class="col-md-11">
					...
					<select name="userId" id="userId" class="head_inp" style="margin-top:15px; margin-left: -5px; max-width: 300px">
						<option value="">ALL</option>
