...
<!DOCTYPE html>
<head>
	<title>Lanewise Traffic Report</title>
	...
	<script>
		...
		var action ="LanewiseTrafficReport";
		...
		function getReport() {
			...
			if (! date_error && ! from_error && ! to_error) {
				...
				url = url + "?from="+from+"&to="+to+"&shiftId="+shiftId+"&jType="+jType;
...
<body style="background-image: url(${pageContext.request.contextPath}/resources/images/TS_BG_03.jpg)">
	<div class="container nopadding hidden-xs">
		...
		<div class="row">
			<div class="col-sm-12 header hidden-print" style=" min-width: 102%;">
				<div class="row">
					...
					<div class="col-xs-5">
							<h4 class="heading" style="font-size: 0.9em">Lanewise Traffic Report</h4>
						<div></div>
					</div>
		...
		<div class="row">
			<div class="col-sm-12 black_header hidden-print">
				...
				<div class="col-md-11">
					...
					<label style="margin-left: -290px">SHIFT: </label>
					...
					<label style="margin-left:50px">JOURNEY TYPE: </label>
					<select name="jType" id="jType" class="head_inp" style="margin-top:15px; max-width: 100px">
						<option value="">ALL</option>
		...
		<div class="row">
			<div class="col-xs-12" style="background-color: #ee9620">
				...
				<br><span style="margin-left:20%">Lanewise Revenue Report</span>
			</div>
		</div>
	...
	<div class="row black_header visible-xs" style="margin-top: -20px">
		<div class="col-xs-12">
			<label style="margin-left:0px">JOURNEY TYPE: </label>
			<select name="jType" id="sjType" class="head_inp" style="margin-top:15px; max-width: 100px">
				<option value="">ALL</option>
				<option value="S">Single</option>
				<option value="R">Return</option>
			</select>
	...
	<script>
		...
		function sgetReport() {
			...
			if (! date_error && ! from_error && ! to_error) {
					...
					document.getElementById("jType").value =document.getElementById("sjType").value;
