...
<head>
	...
	<style>
	    ...
	    border-top: 16px solid #ee9620; /* Blue */
	    border-radius: 50%;
	    width: 120px;
	    height: 120px;
	...
	<script>
		...
		function getReport() {
			...
			if (! date_error && ! from_error && ! to_error) {
				...
				url = url+"&tollPlazaId="+plazaId+"&action=LoginLogoutReport";
		...
		function stateChange() {
			 if (xmlHttp.readyState==4||xmlHttp.readyState=="complete") {
				 ...
				 //window.open('${pageContext.request.contextPath}/Desktop/jasperIntegration/LoginLogoutReport.pdf', '_blank');
				 //window.open('${pageContext.request.contextPath}/JasperReports/LoginLogoutReport.pdf', '_blank');
				 var str = xmlHttp.responseText;
				 str = str.trim();
				 if (str=="logged_out") {
					 localStorage.clear();
					 ...
					 //window.open('${pageContext.request.contextPath}/jasper/iframe?action=LoginLogoutReport', '_blank');	 	 	 
					 if(/Mobile/i.test(navigator.userAgent) && !/ipad/i.test(navigator.userAgent) ){
							window.open('${pageContext.request.contextPath}/jasper/iframe?action=LoginLogoutReport&type='+'html', '_blank');	 
					    } else {
					    	window.open('${pageContext.request.contextPath}/jasper/iframe?action=LoginLogoutReport&type='+'pdf', '_blank');	 
					    }
				 } 
	...
	<div class="container nopadding hidden-xs">
		...
		<div class="row">
			<div class="col-sm-12 header hidden-print" style=" min-width: 102%;">
				<div class="row">
					...
					<div class="col-xs-5">
							<h4 class="heading" style="font-size: 0.9em">Login Logout Report</h4>
						<div></div>
					</div>
		...
		<div class="row">
			<div class="col-xs-12" style="background-color: #ee9620">
				...
				<br><span style="margin-left:20%">Login/ Logout Report</span>
			</div>
		</div>
