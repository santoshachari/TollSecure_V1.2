...
<!DOCTYPE html>
<head>
	<title>Monthly Pass Detail Report</title>
	...
	<script>
		...
		var action = "MonthlyPassDetailsReport";
		...
		function showLanesDirections(plazaId) {
			...
			//bring lanes
			var url="${pageContext.request.contextPath}/lane/listLaneCodes1?plazaId="+plazaId;
			...
			if (! date_error && ! from_error && ! to_error) {
				...
				var table = 
					...
					"<table style='margin-left: 10px'>"+
						...
						"<tr><th>GeneratedBy: "+document.getElementById("genBy").value+"</th><th>TC. "+selectedUser+"</th>"+
					"</table>"; 
				...
				url = url + "?from="+from+"&to="+to+"&shiftId="+shiftId+"&userId="+userId;
		...
		function stateChange() {
			 if (xmlHttp.readyState==4||xmlHttp.readyState=="complete") {
				 ...
				 if (str=="logged_out") {
					 localStorage.clear();
					 window.open('${pageContext.request.contextPath}/index/logout');
				 } else {
...
<body style="background-image: url(${pageContext.request.contextPath}/resources/images/TS_BG_03.jpg)">
		...
		<div class="row">
			<div class="col-sm-12 header hidden-print" style=" min-width: 102%;">
				<div class="row">
					...
					<div class="col-xs-5">
							<h4 class="heading" style="font-size: 0.9em">Monthly Pass Detail</h4>
						<div></div>
					</div>
	...
	<div class="visible-xs container" >
		...
		<div class="row">
			<div class="col-xs-12" style="background-color: #ee9620">
				...
				<br><span style="margin-left:20%">Monthly Pass Detail Report</span>
			</div>
		</div>
	...
	<div class="row black_header visible-xs" style="margin-top: -20px">
		<div class="col-xs-12">
			<label style="margin-left: 0px">USER: </label>
