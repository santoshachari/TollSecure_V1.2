...
<!DOCTYPE html>
<head>
	<title>Consolidated Traffic and Revenue Report</title>
	...
	<script>
		...
		var action = null;
		 if(/Mobile/i.test(navigator.userAgent) && !/ipad/i.test(navigator.userAgent) ){
				action = "ConsolidatedTrafficandRevenueReportMobile";
		    } else {
		    	action = "ConsolidatedTrafficandRevenueReport";
		    }
...
<body style="background-image: url(${pageContext.request.contextPath}/resources/images/TS_BG_03.jpg)">
		...
		<div class="row">
			<div class="col-sm-12 header hidden-print" style=" min-width: 102%;">
				<div class="row">
					...
					<div class="col-xs-5">
							<h4 class="heading" style="font-size: 0.9em">Consolidated Traffic Revenue Report</h4>
						<div></div>
					</div>
		...
		<div class="row">
			<div class="col-sm-12 black_header hidden-print">
				...
				<div class="col-md-11">
					...
					<select name="userId" id="userId" class="head_inp" style="margin-top:15px; margin-left: 0px; max-width: 100px">
						<option value="">ALL</option>
	...
	<div class="visible-xs container" >
		...
		<div class="row">
			<div class="col-xs-12" style="background-color: #ee9620">
				...
				<br><span style="margin-left:7%">Consolidated Traffic And Revenue Report</span>
			</div>
		</div>
	...
	<script>
		var x=document.getElementById("sdplaza").value;
