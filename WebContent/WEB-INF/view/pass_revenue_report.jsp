...
<!DOCTYPE html>
<head>
	<title>Pass Revenue Report</title>
	...
	<script>
		...
		var action ="MonthlyPassRevenueReport";
		...
		function getReport() {
			...
			if (! date_error && ! from_error && ! to_error) {
				...
				url = url + "?from="+from+"&to="+to+"&shiftId="+shiftId;
		...
		<div class="row">
			<div class="col-sm-12 header hidden-print" style=" min-width: 102%;">
				<div class="row">
					...
					<div class="col-xs-5">
							<h4 class="heading" style="font-size: 0.9em">Pass Revenue Report</h4>
						<div></div>
					</div>
		...
		<div class="row">
			<div class="col-sm-12 black_header hidden-print">
				...
				<div class="col-md-11">
					...
					<label style="margin-left: -235px">SHIFT: </label>
					...
					<%-- <label style="margin-left: 400px">GENERATED BY. </label>
	...
	<div class="visible-xs container" >
		...
		<div class="row">
			<div class="col-xs-12" style="background-color: #ee9620">
				...
				<br><span style="margin-left:7%">Monthly Pass Revenue Report</span>
			</div>
		</div>
