...
<!DOCTYPE html>
<head>
	<title>Exempt Traffic Report</title>
	...
	<script>
		...
		var action = "ExemptedTrafficReport";
	...
	<div class="container nopadding hidden-xs">
		...
		<div class="row">
			<div class="col-sm-12 header hidden-print" style=" min-width: 102%;">
				<div class="row">
					...
					<div class="col-xs-5">
							<h4 class="heading" style="font-size: 0.9em">Exempted Traffic Report</h4>
						<div></div>
					</div>
		...
		<div class="row">
			<div class="col-xs-12" style="background-color: #ee9620">
				...
				<br><span style="margin-left:7%">Exempted Traffic Report</span>
			</div>
		</div>
